    ...
    <BasicComponent title="課程管理" :totalCount="`${totalCount} 筆`">
      ...
      <template #data-table>
        <el-table v-loading="loading" :data="courseList" empty-text="暫無課程資料">
          <el-table-column prop="courseId" label="課程 ID" min-width="220" :show-overflow-tooltip="true" />
...
import { findCourseListByCateforyIdAndPaginationApi } from '@/api/course/course';
