...
import { deleteCompanyCourseByIdApi, findCompanyCourseListByQueryTextAndPaginationApi } from '@/api/companyCourse';
import { CompanyCourseVO } from '@/api/companyCourse/type';
